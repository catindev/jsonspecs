...
Детерминированный движок JSON-правил для Node.js. Версия 3 реализует исполняемый контракт `jsonspecs/spec` **1.0.0-rc.5**.
...
Версия 3 принимает только `formatVersion: 2`. Разобранные авторские файлы, описания, папки, импорты и метаданные проекта не относятся к исполняемому снэпшоту.
...
Подробности: [спецификация поведения](https://github.com/jsonspecs/spec/blob/d7f07976b0fe004584217adf079c57caec102ab3/SPEC_RU.md),
[реализация движка](IMPLEMENTATION_RU.md), [операторы](OPERATORS_RU.md),
[переход на v3](MIGRATION_V3.md), [проверки](TESTING.md).
